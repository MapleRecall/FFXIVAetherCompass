...
internal static unsafe class Quests
{
	...
	public static unsafe Quest* GetQuestListArray()
		=> questListArray;

	public const int QuestListArrayLength = 30;

	public static unsafe bool HasQuest(ushort questId)
	{
	...
	public static unsafe bool TryGetQuest(ushort questId, out Quest quest)
	{
		quest = new();
		if (questId == 0) return false;
		var array = GetQuestListArray();
